...
exports.matrix = __webpack_require__(45);
...
var newtonRaphton = __webpack_require__(19);
...
var EquationSet = __webpack_require__(18);
var deepcopy = __webpack_require__(7);
var Equilibrium = __webpack_require__(6);
...
class Serie {
    ...
    getTitration(options) {
        ...
        var xy = [];
        for (var _i = 0; _i < ph.length; _i++) {
            xy.push(vols[_i], ph[_i]);
        }
...
var Equation = __webpack_require__(17);
class EquationSet {
    ...
    getEquations(options) {
        options = options || {};
        return Array.from(this._equations).filter(e => options.includeDisabled || !this._disabledKeys.has(e[0])).map(e => {
            var r = e[1].toJSON();
    ...
    getModel(totals, all) {
        ...
        var subsetKeys = [...subset.keys()];
        var subsetArr = [...subset.values()].filter((s, idx) => !this._disabledKeys.has(subsetKeys[idx]));
...
function normalize(equations) {
    ...
    while (!allDefined(newEquations) && iter < 10) {
        for (var _i = 0; _i < N; _i++) {
            if (!newEquations[_i]) {
                if (allDefined(newEquations, needs[_i])) {
                    fillLine(equations, newEquations, _i);
                }
            }
        }
        iter++;
...
function fillRec(equations, eq, eqToFill, n) {
    ...
    var _loop = function _loop(j) {
        ...
        rep = equations.find(eq => eq.formed === keys[j]);
...
var Matrix = __webpack_require__(12);
var stat = __webpack_require__(5).matrix;
var debug = __webpack_require__(23)('core:newton-rahpton');
...
var Serie = __webpack_require__(15);
...
var _polyfill = __webpack_require__(8);
